  ...
  return (
    ...
    >
      <style>{`
        ...
        .seal-line { width: 28px; height: 1px; background: rgba(234,179,8,0.3); display: inline-block; vertical-align: middle; margin: 0 8px; }
      `}</style>
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div className="text-center mb-8">
          <div
            ...
            style={{ width: 72, height: 72, borderRadius: "50%", border: "1px solid rgba(234,179,8,0.3)", background: "rgba(234,179,8,0.08)" }}
          >
            <svg style={{ width: 28, height: 28 }} fill="none" stroke="#fbbf24" strokeWidth="1.5" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-center mb-3">
            ...
            <span style={{ fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(251,191,36,0.8)", fontWeight: 600 }}>
              Access forbidden
            </span>
            <span className="seal-line" />
          </div>
          ...
          <p style={{ fontSize: 13, color: "#71717a", lineHeight: 1.7, margin: 0 }}>
            Your account does not have the required permissions for this resource. This is different from being signed out — you are signed in, but access has been denied.
          </p>
        </div>
        ...
        <div style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 20, padding: "24px" }}>
          ...
          {[
            { label: "Wrong account role", body: "This page is restricted to a specific role such as admin, lawyer, or client." },
            { label: "Insufficient plan", body: "Your current subscription does not include access to this feature." },
            { label: "Admin-only resource", body: "This action is reserved for administrators and cannot be accessed by regular users." },
          ].map(({ label, body }) => (
            <div className="info-row" key={label}>
              <div style={{ width: 32, height: 32, borderRadius: 8, background: "rgba(234,179,8,0.08)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <svg style={{ width: 15, height: 15 }} fill="none" stroke="#fbbf24" strokeWidth="1.5" viewBox="0 0 24 24">
