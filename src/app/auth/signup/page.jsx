...
// inline SVG icons so no extra deps needed
const UserIcon = () => (
...
// plan assigned automatically based on role
...
export default function SignupPage() {
    ...
    const handleSignup = async (e) => {
        ...
        // plan is derived from role — no user choice needed
        ...
        const { error: authError } = await authClient.signUp.email({
            ...
            plan,   // "client_basic" or "lawyer_associate"
        });
        ...
        >
            ...
            <div style={{ width: "100%", maxWidth: 420 }}>
                ...
                <div style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 20, padding: "28px 28px 24px" }}>
                    ...
                    {/* Role selector — pick first, plan is automatic */}
                    <div className="mb-6">
                    ...
                    <Link href={`/auth/signin?redirect=${redirectTo}`}>
                        <button style={{ width: "100%", padding: "11px", borderRadius: 12, fontSize: 12, fontWeight: 600, color: "#a1a1aa", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", cursor: "pointer", transition: "border-color 0.2s" }}
